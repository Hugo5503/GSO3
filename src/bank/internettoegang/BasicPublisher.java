...
public class BasicPublisher {
    ...
    public BasicPublisher(String[] properties) {
        listenersTable = new HashMap<String, Set<IRemotePropertyListener>>();
        listenersTable.put(null, new HashSet<IRemotePropertyListener>());
        for (String s : properties) {
            listenersTable.put(s, new HashSet<IRemotePropertyListener>());
        }
        setPropertiesString();
    }
